...
import './ArrowUp-3efca1ba.js';
import { i as icons } from './iconsList-0ef1935c.js';
...
const inputHiweb = class {
  ...
  render() {
    ...
    return (h("div", null, h("div", { class: "input-container" }, h("label", null, this.label), this.isChanged
      ...
      ? h("div", { innerHTML: icons['xMark'], class: "img", style: this.checkFocus(), onClick: () => this.clearInput() })
